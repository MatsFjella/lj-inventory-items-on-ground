    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p style=\"font-size:11px\"><b>Vekt: </b>" + itemData.weight + " | <b>Mengde: </b> " + itemData.amount + " | <b>Kvalitet: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>"
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Fødselsdato: </strong><span>" +
                itemData.info.birthdate +
                "</span></p><p><strong>Lisens: </strong><span>" +
                itemData.info.type +
                "</span></p>"
            );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
                $(".item-info-description").html(
                    "<p><strong>Item number: </strong><span>" +
                    (itemData.info.Drawable ? itemData.info.Drawable : 0)  +
                    "</span></p><p><strong>Texture: </strong><span>" +
                    (itemData.info.Texture ? itemData.info.Texture : 0) +
                    "</span></p>"
                );
            ...
            $(".item-info-description").html( // might need to come back
                "<p>" + itemData.info.uses + "% bruk igjen.</p><p style=\"font-size:11px\"><b>Vekt: </b>" + itemData.weight + " | <b>Antall: </b> " + itemData.amount + " | <b>Kvalitet: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>"
            );
            ...
            $(".item-info-title").html('<p> Kjøretøy: '+ itemData.info.label +'</p>')
            $(".item-info-description").html('<p> Skilt: '+ itemData.info.plate + '</p>');
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
                if (itemData.info.type == "casing") {
                    if (itemData.info.evidenceNote != null) {
                        $(".item-info-description").html(
                            "<p><strong>Bevismateriale: </strong><span>" + itemData.info.label + "</span></p>" +
                            "<p><strong>Type: </strong><span>" + itemData.info.ammotype + "</span></p>" +
                            "<p><strong>Kaliber: </strong><span>" + itemData.info.ammolabel + "</span></p>" +
                            "<p><strong>Serienummer: </strong><span>" + itemData.info.serie + "</span></p>" +
                            "<p><strong>Område: </strong><span>" + itemData.info.street + "</span></p>" +
                            "<br /><p><strong>Notat: </strong><span>" + itemData.info.noteWrite + "</span></p>" +
                            "<p><strong>Notat: </strong><span>" + itemData.info.evidenceNote + "</span></p>"
                        );
                    } else {
                        $(".item-info-description").html(
                            "<p><strong>Bevismateriale: </strong><span>" + itemData.info.label + "</span></p>" +
                    ...
                    if (itemData.info.evidenceNote != null) {
                        $(".item-info-description").html(
                            "<p><strong>Bevismateriale: </strong><span>" + itemData.info.label +"</span></p>" +
                            "<p><strong>Blodtype: </strong><span>" + itemData.info.bloodtype +"</span></p>" +
                            "<p><strong>DNA Kode: </strong><span>" + itemData.info.dnalabel +"</span></p>" +
                            "<p><strong>Område: </strong><span>" + itemData.info.street +"</span></p>" +
                            "</br><p><strong>Hvem skrev notat: </strong><span>" + itemData.info.noteWrite + "</span></p>" +
                            "<p><strong>Notat: </strong><span>" + itemData.info.evidenceNote + "</span></p>"
                        );
                    } else {
                        $(".item-info-description").html(
                    ...
                    if (itemData.info.evidenceNote != null) {
                        $(".item-info-description").html(
                            "<p><strong>Bevismateriale: </strong><span>" + itemData.info.label + "</span></p>" +
                            "<p><strong>Fingeravtrykk: </strong><span>" + itemData.info.fingerprint + "</span></p>" +
                            "<p><strong>Område: </strong><span>" + itemData.info.street + "</span></p>" +
                            "</br><p><strong>Hvem skrev notat: </strong><span>" + itemData.info.noteWrite + "</span></p>" +
                            "<p><strong>Notat: </strong><span>" + itemData.info.evidenceNote + "</span></p>"
                        );
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.info.costs + "</p><p style=\"font-size:11px\"><b>Vekt: </b>" + itemData.weight + " | <b>Antall: </b> " + itemData.amount + " | <b>Kvalitet: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "stickynote") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.info.label + "</p><p style=\"font-size:11px\"><b>Vekt: </b>" + itemData.weight + " | <b>Antall: </b> " + itemData.amount + " | <b>Kvalitet: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "moneybag") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Amount of cash: </strong><span>$" +
                itemData.info.cash +
                "</span></p><p style=\"font-size:11px\"><b>Vekt: </b>" + itemData.weight + " | <b>Vekt: </b> " + itemData.amount + " | <b>Antall: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>"
            );
            ...
            var cardNumber = "************" + res;
            $(".item-info-description").html('<p><strong>Card Holder: </strong><span>' + itemData.info.name + '</span></p><p><strong>Citizen ID: </strong><span>' + itemData.info.citizenid + '</span></p><p><strong>Card Number: </strong><span>' + cardNumber + '</span></p><p style=\"font-size:11px\"><b>Vekt: </b>' + itemData.weight + " | <b>Amount: </b> " + itemData.amount + " | <b>Quality: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        } else if (itemData.name == "labkey") {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>Lab: " + itemData.info.lab + "</p><p style=\"font-size:11px\"><b>Vekt: </b>" + itemData.weight + " | <b>Antall: </b> " + itemData.amount + " | <b>Kvalitet: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        } else {
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:11px\"><b>Vekt: </b>" + itemData.weight + " | <b>Antall: </b> " + itemData.amount + " | <b>Kvalitet: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
        }
    } else {
        $(".item-info-title").html("<p>" + itemData.label + "</p>");
        $(".item-info-description").html("<p>" + itemData.description + "</p><p style=\"font-size:11px\"><b>Vekt: </b>" + itemData.weight + " | <b>Antall: </b> " + itemData.amount + " | <b>Kvalitet: </b> " + "<a style=\"font-size:11px;color:green\">" + Math.floor(itemData.info.quality) + "</a>");
...
(() => {
    ...
    Inventory.itemBox = function(data) {
        ...
        if (data.type == "add") {
          type = "Mottok " + data.itemAmount;
        } else if (data.type == "remove") {
          type = "Mistet " + data.itemAmount;
        }
