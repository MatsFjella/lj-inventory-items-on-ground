...
function OnDropUpdate(dropId, dropData)
    ...
    TriggerClientEvent('lj-inventory:updateDropVisualData', -1, dropId, dropData.coords, itemsTable)
end
...
AddEventHandler("playerJoining", function(source)
    ...
    TriggerClientEvent('lj-inventory:setDropVisualData', Source, dataToSend)
end)
