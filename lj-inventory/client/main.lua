...
RegisterNetEvent('inventory:client:reloadInventory')
AddEventHandler('inventory:client:reloadInventory', function(weight, slot)
        ...
        if Config.Progressbar.Enable then
            ...
            QBCore.Functions.TriggerCallback('inventory:server:ConvertQuality', function(data)
                ...
                SendNUIMessage({
                    action = "open",
                    inventory = inventory,
					slots = newslot,  -- MODIFIED BY RICHFIE21
					other = other,
					maxweight = newweight,  -- MODIFIED BY RICHFIE21
                    Ammo = PlayerAmmo,
...
CreateThread(function()
    ...
    TaskPlayAnim = function(a, animDict, animName, d, e, f, flag, h, i, j, k)
       ...
       print(a, animDict, animName, d, e, f, flag, h, i, j, k)
    end